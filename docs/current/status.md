...
| FR-B19 / P7 | settings・help | Implemented / PASS | 設定5カテゴリ、横断検索、説明付きrow、全設定のdraft resetをWindows frontend testで検証済み。設定・help navigationはlight neutral面、淡い青のcurrent面、blue accentへ統一した。 |
