...
| 範囲 | 状態 | 備考 |
|---|---|---|
| REQ-MVP-001〜007, 009〜017, 019 | Implemented / PASS | root登録画面なしのExplorer shell、PC配下のWindows drive列挙・選択・切替、通常pathのaddress表示、catalog、viewer、読書位置、原本非破壊、error回復をWindows Rust canonicalとfrontend testで直接観測済み。 |
