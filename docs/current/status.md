...
| FR-B03 | catalog表示形式 | Implemented / PASS | 詳細、小サムネイル、表紙グリッド、カードグリッドの順序・名称、形式別固定thumbnail幅、表紙中心の縦型gridと属性付き横長cardの区別、ファイル名非重複、profile v1移行とSQLite再起動復元をWindows frontend/Rust/Python testで検証。 |
