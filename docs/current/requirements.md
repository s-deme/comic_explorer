...
| NFR-MVP-003 | tree、catalog、viewerをkeyboardで操作でき、focusを視認できる。menuとaddress barは文字と操作性を保ったcompactな高さとし、tree labelは選択状態によらず背景と判別できる文字色で表示する。 | UIA、screen reader、high contrast、DPIはBLOCKED。 |
...
| FR-B11 入力拡張 | REQ-FR-B11-001, REQ-FR-B11-002, REQ-FR-B11-003, REQ-FR-B11-004 | FUT-C-019, FUT-R-006, FUT-R-007 | keyboard commandのremap、conflict拒否、reset、focus fallback、再起動保存、helpを保証する。touch/gamepadは候補のまま。 |
...
| P9 / FR-B12 | FUT-C-001, 002 | RAR/CBR/7zを安全にunsupported分類する。readerは未採用。 |
...
| Partial | FUT-C-001, FUT-C-002, FUT-C-006, FUT-C-007, FUT-C-008 | unsupported/parser境界だけ実装済み。完全reader/decodeを推定しない。 |
