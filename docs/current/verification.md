...
| TypeScript/frontend | PASS | 2026-08-11、24 files / 198 tests PASS、FAIL 0。対応書庫の項目別形式表示、検索条件のrequest変換・検索結果保持、一般ヘルプとバージョン情報の分離、診断のread-only説明と実行中indicator、catalogの利用可能幅に応じたcard列数・virtual行の縮退、TypeScript typecheckもexit 0。 |
