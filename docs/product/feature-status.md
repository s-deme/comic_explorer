...
| REQ-MVP-016 | 巻末動作 | 並べ替え順の次作品へ移動 | Implemented | PASS | Must | MVP | [REQ](../requirements/mvp-requirements.md#req-mvp-016-巻末動作) | `src/App.tsx`; `src/features/catalog/sort.ts` | TC-UT-010, TC-UI-014, TC-E2E-003 | 固定の既定動作は直接観測PASS。設定化は候補行で管理 |
...
| FUT-C-018 | 任意倍率ズーム | 任意倍率で拡大・縮小 | Candidate | NOT TESTED | 希望 | 将来 | Q5-4 [questionnaire](../requirements/product-questionnaire.md) | — | 未実装・未実測 | Q5-4から分離した原子候補 |
...
| FUT-C-020 | 巻末動作設定・自動遷移 | 自動的に次の巻を開く設定 | Candidate | NOT TESTED | 希望 | 将来 | Q5-6 [questionnaire](../requirements/product-questionnaire.md) | — | 未実装・未実測 | 固定のMVP既定動作とは別の設定機能 |
...
| FUT-C-033 | 横幅フィット | 表示領域の横幅に合わせる | Candidate | NOT TESTED | 希望 | 将来 | Q5-4 [questionnaire](../requirements/product-questionnaire.md) | — | 未実装・未実測 | Q5-4から分離した原子候補 |
| FUT-C-034 | 高さフィット | 表示領域の高さに合わせる | Candidate | NOT TESTED | 希望 | 将来 | Q5-4 [questionnaire](../requirements/product-questionnaire.md) | — | 未実装・未実測 | Q5-4から分離した原子候補 |
| FUT-C-035 | 原寸表示 | 画像を原寸で表示する | Candidate | NOT TESTED | 希望 | 将来 | Q5-4 [questionnaire](../requirements/product-questionnaire.md) | — | 未実装・未実測 | Q5-4から分離した原子候補 |
| FUT-C-036 | ズーム状態維持 | 作品・ページ移動後も倍率を維持する | Candidate | NOT TESTED | 希望 | 将来 | Q5-4 [questionnaire](../requirements/product-questionnaire.md) | — | 未実装・未実測 | Q5-4から分離した原子候補 |
| FUT-C-037 | ルーペ | ポインタ周辺を拡大する | Candidate | NOT TESTED | 希望 | 将来 | Q5-4補足 [questionnaire](../requirements/product-questionnaire.md) | — | 未実装・未実測 | 補足記述から導いた推論由来候補 |
| FUT-C-038 | 巻末動作設定・確認 | 確認後に次の巻を開く設定 | Candidate | NOT TESTED | 希望 | 将来 | Q5-6 [questionnaire](../requirements/product-questionnaire.md) | — | 未実装・未実測 | Q5-6から分離した原子候補 |
| FUT-C-039 | 巻末動作設定・一覧復帰 | 巻末でライブラリ画面へ戻る設定 | Candidate | NOT TESTED | 希望 | 将来 | Q5-6 [questionnaire](../requirements/product-questionnaire.md) | — | 未実装・未実測 | Q5-6から分離した原子候補 |
| FUT-C-040 | 巻末動作設定・停止 | 巻末で何もしない設定 | Candidate | NOT TESTED | 希望 | 将来 | Q5-6 [questionnaire](../requirements/product-questionnaire.md) | — | 未実装・未実測 | Q5-6から分離した原子候補 |
| FUT-C-041 | 巻末動作設定・ループ | 末尾から先頭へループする設定 | Candidate | NOT TESTED | 希望 | 将来 | Q5-6 [questionnaire](../requirements/product-questionnaire.md) | — | 未実装・未実測 | Q5-6から分離した原子候補 |
