...
| FUT-C-021 | お気に入り保存 | お気に入り永続化 | Candidate | NOT TESTED | 希望 | FR-B06 | [FR-B06要件](../requirements/favorites-requirements.md#fr-b06-お気に入り要件); Q6-1 [questionnaire](../requirements/product-questionnaire.md) | shared FR-B06 implementation | 未実装・未実測 | IMP-014 Next。restart/migration/missing/moved/re-resolveは未測定で、FUT-C-011のPASSから昇格させない。 |
