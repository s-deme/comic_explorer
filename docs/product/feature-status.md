...
| FUT-C-016 | 横スクロール | 閲覧方式切替 | Implemented | PASS | 希望 | FR-B04 | [FR-B04要件](../requirements/viewer-layout-requirements.md#req-fr-b04-001-layout-enum-and-default); Q5-1 [questionnaire](../requirements/product-questionnaire.md) | `src/features/viewer/model.ts`; `src/features/viewer/Viewer.tsx`; `src/styles.css`; `src/App.tsx` | [FT-B04-002](../testing/fr-b04-results.md#ft-b04-002), [FT-B04-003](../testing/fr-b04-results.md#ft-b04-003), [FT-B04-005](../testing/fr-b04-results.md#ft-b04-005) | focused connected evidence、canonical aggregate、CoDD consistency PASS。Windows product gateはFUT-C-017に分離 |
