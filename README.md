...
| 種類 | 対応形式 |
|---|---|
| 画像 | BMP、JPEG/JPG、GIF、TIFF/TIF、PNG、ICO、SVG、WebP（アニメーションを含む）、AVIF（環境・画像構造による制限あり） |
| 文書 | PDF |
...
- Windows専用です。
- AVIFはWebView2で表示します。画像構造によって開けない場合があり、サムネイル・フィルター・画像コピーはWindows側の対応コーデックにも依存します。
