...
const COPY: Record<ErrorCode, ErrorCopy> = {
  INVALID_REQUEST: { title: "対応していません", guidance: "対応する画像、ZIP、CBZ、EPUB、RARを選んでください。" },
  INVALID_PATH: { title: "対応していません", guidance: "対応する画像、ZIP、CBZ、EPUB、RARを選んでください。" },
  ...
  UNSUPPORTED_FORMAT: { title: "対応していません", guidance: "対応する画像、ZIP、CBZ、EPUB、RARを選んでください。" },
