...
const COPY: Record<ErrorCode, ErrorCopy> = {
  INVALID_REQUEST: { title: "対応していません", guidance: "対応する画像、ZIP、CBZ、EPUBを選んでください。" },
  INVALID_PATH: { title: "対応していません", guidance: "対応する画像、ZIP、CBZ、EPUBを選んでください。" },
  ...
  UNSUPPORTED_FORMAT: { title: "対応していません", guidance: "対応する画像、ZIP、CBZ、EPUBを選んでください。" },
