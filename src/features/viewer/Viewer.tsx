  ...
  return (
    ...
    >
          ...
          <section className="viewer-more-group" aria-labelledby="viewer-more-navigation-title">
            ...
            <div className="viewer-more-actions">
              ...
              <button
                ...
                onClick={randomPage}
              >
                <span aria-hidden="true">⤨</span><span>ランダム</span>
              </button>
              <button
                className="viewer-more-action viewer-page-action--slideshow"
                type="button"
              ...
              >
                <span aria-hidden="true">{slideshowRunning ? "Ⅱ" : "▷"}</span><span>スライドショー</span>
              </button>
            </div>
          </section>
      ...
      >
        ...
        <button
          className="viewer-icon-button viewer-page-index"
          type="button"
          aria-label="ページ一覧"
