        ...
        <div className="settings-dialog-body">
          ...
          <div className="settings-content">
            ...
            <section className="settings-panel" aria-label="ビューワ設定" hidden={panelHidden("viewer")}>
              ...
              <details className="settings-advanced" open={isSearching ? true : undefined} hidden={groupHidden(["spread-portrait-ratio", "auto-spread-viewport-ratio", "spread-first-page-single", "spread-pairing"])}>
              ...
              <details className="settings-advanced settings-advanced--compact" open={isSearching ? true : undefined} hidden={groupHidden(["viewer-prefetch"])}>
              ...
              <details className="settings-advanced" open={isSearching ? true : undefined} hidden={groupHidden(["fit-upscale", "fit-basis", "fit-margin"])}>
              ...
              <details className="settings-advanced" open={isSearching ? true : undefined} hidden={groupHidden(["zoom-retention", "viewer-grid"])}>
