...
export const BUILTIN_THEMES: Readonly<Record<BuiltinThemeId, ThemeDefinitionV1>> = Object.freeze({
  ...
  sakura: builtinTheme("sakura", "light", {
    canvas: "#FFF5F6",
    surface: "#FFFFFF",
    surfaceMuted: "#F9E7EA",
    surfaceRaised: "#FFFDFD",
    text: "#2D1D22",
    textMuted: "#5E4750",
    border: "#876F78",
    accent: "#A61B45",
  ...
  ocean: builtinTheme("ocean", "light", {
    canvas: "#F1F7FC",
    surface: "#FFFFFF",
    surfaceMuted: "#E0EEF9",
  ...
  meadow: builtinTheme("meadow", "light", {
    canvas: "#F0F8F0",
    surface: "#FFFFFF",
    surfaceMuted: "#E1F1E2",
  ...
  lavender: builtinTheme("lavender", "light", {
    canvas: "#F7F4FC",
    surface: "#FFFFFF",
    surfaceMuted: "#EBE5F6",
    surfaceRaised: "#FEFDFF",
    text: "#29213B",
    textMuted: "#5B536D",
    border: "#7A718C",
    accent: "#5B3E9E",
