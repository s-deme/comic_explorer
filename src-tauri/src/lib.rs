...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            application::get_last_folder,
            application::save_last_folder,
            ...
            application::reading::list_page_bookmarks,
            application::reading::save_page_bookmark,
            application::reading::delete_page_bookmark,
            application::reading::list_reading_history,
            application::reading::clear_reading_history,
            ...
            application::settings_commands::set_shortcut_bindings,
            application::settings_commands::set_viewer_settings,
            application::settings_commands::set_settings_profile,
            application::settings_commands::list_named_settings_profiles,
            application::settings_commands::save_named_settings_profile,
            application::settings_commands::preview_named_settings_profile_switch,
            application::settings_commands::execute_named_settings_profile_switch,
            application::settings_commands::delete_named_settings_profile,
            application::themes::list_custom_themes,
            application::themes::save_custom_theme,
            application::themes::delete_custom_theme,
            application::themes::export_custom_theme,
            application::themes::preview_custom_theme_import,
            application::themes::execute_custom_theme_import,
            ...
            application::offline_media::list_offline_media,
            application::offline_media::register_offline_media,
            application::offline_media::cancel_offline_media_registration,
            application::offline_media::get_offline_media,
            application::offline_media::get_offline_media_thumbnail,
            application::offline_media::set_offline_media_icon,
            application::offline_media::delete_offline_media,
            application::offline_media::open_offline_media_entry,
            application::viewer_filters::list_viewer_filter_sets,
            application::viewer_filters::save_viewer_filter_set,
            application::viewer_filters::activate_viewer_filter_set,
            application::viewer_filters::delete_viewer_filter_set,
            ...
            application::catalog_masks::evaluate_catalog_mask,
            application::catalog_masks::list_catalog_masks,
            application::catalog_masks::save_catalog_mask,
            application::catalog_masks::delete_catalog_mask,
            ...
            application::reading::save_reading_position,
