...
#[cfg(test)]
use migrations::migrate_through;
#[path = "catalog_repository.rs"]
mod catalog_repository;
#[path = "integration_repository.rs"]
mod integration_repository;
#[path = "reading_repository.rs"]
mod reading_repository;
#[path = "settings_repository.rs"]
mod settings_repository;
pub use settings_repository::Settings;
